...
def run_pipeline(ticker_file: Path, feature_dir: Path = config.FEATURE_DIR,
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python scripts/run_data_pipeline.py <ticker_file.txt>")
        sys.exit(1)
    ...
    run_pipeline(ticker_file_path, debug=False)
